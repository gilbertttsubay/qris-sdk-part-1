...
@IBDesignable
class QRLKPINView: UIControl, UIKeyInput {
    
    //config
    static var bgBorderColor : UIColor = QRBaseColor.pinPlaceholderColor
    static var bgColorPlaceholder : UIColor = QRBaseColor.QRProperties.baseColor
    static var bgColorFilled : UIColor = QRBaseColor.pinPlaceholderColor
    static let borderWidth : CGFloat = 1.0
    
    static func setupWhiteBackground(){
        QRLKPINView.bgBorderColor = QRBaseColor.QRProperties.baseColor
        QRLKPINView.bgColorFilled = QRBaseColor.QRProperties.baseColor
        QRLKPINView.bgColorPlaceholder = .white
    }
    
    static func setupBaseBackground(){
        QRLKPINView.bgBorderColor = QRBaseColor.pinPlaceholderColor
        QRLKPINView.bgColorPlaceholder = QRBaseColor.QRProperties.baseColor
        QRLKPINView.bgColorFilled = QRBaseColor.pinPlaceholderColor
    }
    
    static func setupBlackColor(){
        QRLKPINView.bgBorderColor = QRBaseColor.black
        QRLKPINView.bgColorPlaceholder = QRBaseColor.white
        QRLKPINView.bgColorFilled = QRBaseColor.black
    }
